...
#                    max_y_o = i * 30
    ...
    def draw_interface(self, screen, size_screen, size_square, inp_score, inp_timer, name_figur):
        color = (255, 255, 255)
...
def main():
    ...
    while running:
        ...
        tetris.draw_interface(screen, size, size_square, score, timer, name_from_figur[figures.index(figure[0])])
        pygame.display.flip()
    pygame.quit()
